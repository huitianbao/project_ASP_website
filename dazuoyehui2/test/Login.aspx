...
<div class="stars"></div>
        ...
        <div style="height:59px; width:80px;margin-left: 50px; margin-top: 110px">
           
          <img src="Images/21.jpg"  width="800px" height="500px"  alt=""/>
        </div>
        <div style="height: 349px; width: 646px; margin-left: 906px; margin-top: 150px">
            <asp:TextBox ID="txtName" runat="server" Height="33px" style="margin-left: 5px; margin-top: 30px" Width="317px" OnTextChanged="txtName_TextChanged"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName" ErrorMessage="请输入用户名！" 
                ForeColor="White" style="font-weight: 700" Font-Underline="True"></asp:RequiredFieldValidator>

            <asp:TextBox ID="txtPassword" runat="server" Height="33px" style="margin-left: 5px; margin-top: 32px;" Width="317px" 
                TextMode="Password" OnTextChanged="txtPassword_TextChanged"></asp:TextBox>

            <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ControlToValidate="txtPassword" ErrorMessage="请输入密码！" ForeColor="White">

            </asp:RequiredFieldValidator>
            <asp:Button ID="btnLogin" runat="server" Height="38px" Text="登录" Width="320px" style="margin-left: 5px; margin-top: 34px" BackColor="#CCCCCC" OnClick="btnLogin_Click" BorderColor="White" />
    </div>
    </form>
