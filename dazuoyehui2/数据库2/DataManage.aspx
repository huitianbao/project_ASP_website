...
<body>
    ...
    <div class="auto-style3">
        ...
        &nbsp;<br />
                            <span class="auto-style2">数据库管理</span><br />
...
&nbsp;
        <asp:GridView ID="gvCategory" runat="server" HorizontalAlign="Center">
        </asp:GridView>
                        <br />
                        <span class="auto-style2">角色管理（点击角色管理）<br />
                        </span>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/RolesUsers.aspx">角色管理</asp:HyperLink>
                        <br />
                        <br />
                        <br />
                        <br />
