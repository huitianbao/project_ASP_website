<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index2.aspx.cs" Inherits="首页_index2" %>
...
<body style="text-align: center">
    <form id="form2" runat="server">
            ...
            <tr>
                ...
                <td class="auto-style10">
                    <asp:Login ID="Login1" runat="server" BackColor="#F7F7DE" BorderColor="#CCCC99" BorderStyle="Solid" BorderWidth="1px" CreateUserText="还没注册"
                         CreateUserUrl="~/登录/注册.aspx"
                        Font-Names="Verdana" Font-Size="10pt" DestinationPageUrl="~/首页/index2.aspx"
                        >
                ...
                <td class="auto-style10">
                    ...
                    <div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:Label ID="Label1" runat="server" Text="Label" BorderColor="Fuchsia" BorderStyle="Inset"></asp:Label>
                            </ContentTemplate>
                            <Triggers>
        ...
        >
            ...
            <StaticSelectedStyle BackColor="#1C5E55" />
                ...
                <table class="auto-style11">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" Height="301px" TextMode="MultiLine" Width="719px" OnTextChanged="TextBox1_TextChanged" style="margin-top: 0px" >普通外科团队参加2017年中华医学会肠外肠内营养学年会
...
2017-05-312017北京医院甲状腺外科研讨会召开暨北京医师协会甲状腺疾病专委会成立
                        ...
                        <td class="auto-style13">
                                ...
                                <asp:Image ID="Image5" runat="server" ImageUrl="~/image/医生.jpg" Width="619px" Height="317px" ImageAlign="Left" />
                                <br />
                    ...
                    <tr>
                        <td class="auto-style15">
                            <asp:Image ID="Image6" runat="server" Height="318px" ImageUrl="~/image/室内0.jpg" Width="726px" />
                        </td>
                        <td class="auto-style13">
                            <asp:Image ID="Image7" runat="server" Height="320px" ImageUrl="~/image/室内1.jpg" Width="619px" ImageAlign="Left" />
                        </td>
                    </tr>
                </table>
