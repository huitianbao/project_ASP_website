<%@ Page Language="C#" AutoEventWireup="true" CodeFile="添加了imagemapIndex.aspx.cs" Inherits="Index" %>
            ...
            <tr>
                <td class="auto-style12">
                    <asp:ImageMap ID="临床科室" runat="server" ImageUrl="~/image/临床科室.PNG" OnClick="ImageMap1_Click" style="margin-right: 19px" Width="1390px">
                        <asp:RectangleHotSpot Bottom="360" Right="220" NavigateUrl="~/导航栏/科室设置/妇瘤科.aspx" />
                        <asp:RectangleHotSpot Bottom="360" Right="400" NavigateUrl="~/导航栏/科室设置/普通妇科.aspx" />
                        <asp:RectangleHotSpot Bottom="360" Right="600" NavigateUrl="~/导航栏/科室设置/生育技术科.aspx" />
                        <asp:RectangleHotSpot Bottom="360" Right="780" NavigateUrl="~/导航栏/科室设置/产科.aspx" />
                        <asp:RectangleHotSpot Bottom="360" Right="960" NavigateUrl="~/导航栏/科室设置/新生儿科.aspx" />
                        <asp:RectangleHotSpot Bottom="360" Right="1160" NavigateUrl="~/导航栏/科室设置/乳腺科.aspx"/>
                        <asp:RectangleHotSpot Bottom="360" Right="1340" NavigateUrl="~/导航栏/科室设置/计划生育科.aspx"/>
